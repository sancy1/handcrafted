...
// import prisma from '@/lib/prisma';
// import { ArtisanProfile, ArtisanProfileFormData } from '@/lib/definitions';
// import { User, ArtisanProfile as PrismaArtisanProfile } from '@prisma/client'; // Import User and ArtisanProfile directly from Prisma client
...
//     // Define a type for the 'artisan' parameter that matches the query result.
//     // This explicitly tells TypeScript the structure, resolving the 'implicit any' error.
//     type ArtisanWithSelectedUser = PrismaArtisanProfile & {
